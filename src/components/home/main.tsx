import { CardArticle } from '@/components/home/card-article'
import { CarouselCategories } from '@/components/carousel'
...
export function Main() {
  ...
  return (
    <main className='w-full my-0 mx-auto mt-10 overflow-x-hidden'>
      ...
      <main className='flex flex-col items-center justify-center gap-y-5 mt-10'>
        <CardArticle />
        <CardArticle />
        <CardArticle />
        <CardArticle />
